...
class _SignFormState extends State<SignForm> {
  ...
  void response(int status, String? token) {
    if(status == 200 && token != null) Navigator.pushNamed(context, ProductPage.routeName);
  }
        ...
        children: [
          ...
          DefaultButton(
            ...
            press: () {
              ...
              //   final userDTO = UserDTO(username: email ?? '', password: password ?? '');
              //   loginApi(userDTO, response);
